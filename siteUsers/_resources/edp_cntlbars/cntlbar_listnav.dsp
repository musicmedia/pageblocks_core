...
<div id="edpcntlbarlist">

<?lassoscript
//	these inputs propogate the filter status when the list navigation buttons are used
$edpView->(drawHomeFilterInputs: $edp_HomeFilterInputs);
?>
